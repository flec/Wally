...
\descFig{img/findWally.jpg}{Mutmasslicher Walter}{Für jedes mutmassliche Augenpaar (Brille) wurden die mittels Matlab-Methode \mbox{\emph{knnsearch}} die nächsten 2 rot/weissen-Flächen (Mütze und T-Shirt) gesucht. Dort wo der Abstand zwischen Augenpaar und den beiden Flächen am kleinsten war, wurde Walter vermutet. Mittels Matlab-Methode \mbox{\emph{plot}} wurde vom Augenpaar aus ein Kreis gezeichnet um den Fund zu markieren.}
